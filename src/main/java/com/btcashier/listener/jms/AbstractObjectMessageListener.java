...
public abstract class AbstractObjectMessageListener implements MessageListener {

    private final static Logger log = Logger.getLogger(AbstractObjectMessageListener.class);
    ...
    protected abstract void onObject(Object obj);
